...
export const environment = {
  production: false,
  API: 'http://localhost:4000/deliverydepymes/api/v1/',
  // API: 'https://hellomundolab.cl:4000/deliverydepymes/api/v1/',
  ...
  DRIVING_API_KEY: '20057893-3eff-45e2-b348-fa30e4d7c4d2',
};
