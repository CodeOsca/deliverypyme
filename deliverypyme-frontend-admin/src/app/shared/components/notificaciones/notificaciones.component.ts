...
export class NotificacionesComponent implements OnInit {
  ...
  constructor(private notificationsService: NotificationsService, private alertService: AlertService) {}
  ...
  setAllInView() {
    this.notificationsService.setAllInView().subscribe(this.getNotifications, this.error);
  }
  ...
  private getNotSeen(notifications: Notification[]) {
    const predicate = (notification: Notification) => notification.wasSeen === false;
